...
public class GetMarketPricesResp  extends com.betfair.www.publicapi.types.exchange.v5.APIResponse  implements java.io.Serializable {
    private com.betfair.www.publicapi.types.exchange.v5.GetMarketPricesErrorEnum errorCode;

    private com.betfair.www.publicapi.types.exchange.v5.MarketPrices marketPrices;
    ...
    public GetMarketPricesResp(
           ...
           com.betfair.www.publicapi.types.exchange.v5.MarketPrices marketPrices,
    ...
    /**
     * Gets the errorCode value for this GetMarketPricesResp.
     * 
     * @return errorCode
     */
    ...
    /**
     * Sets the errorCode value for this GetMarketPricesResp.
     * 
     * @param errorCode
     */
    ...
    /**
     * Gets the marketPrices value for this GetMarketPricesResp.
     * 
     * @return marketPrices
     */
    public com.betfair.www.publicapi.types.exchange.v5.MarketPrices getMarketPrices() {
        return marketPrices;
    }


    /**
     * Sets the marketPrices value for this GetMarketPricesResp.
     * 
     * @param marketPrices
     */
    public void setMarketPrices(com.betfair.www.publicapi.types.exchange.v5.MarketPrices marketPrices) {
        this.marketPrices = marketPrices;
    }


    /**
     * Gets the minorErrorCode value for this GetMarketPricesResp.
     * 
    ...
    /**
     * Sets the minorErrorCode value for this GetMarketPricesResp.
     * 
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof GetMarketPricesResp)) return false;
        GetMarketPricesResp other = (GetMarketPricesResp) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(GetMarketPricesResp.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://www.betfair.com/publicapi/types/exchange/v5/", "GetMarketPricesResp"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.betfair.com/publicapi/types/exchange/v5/", "MarketPrices"));
