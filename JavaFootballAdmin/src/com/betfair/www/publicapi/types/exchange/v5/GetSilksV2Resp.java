...
public class GetSilksV2Resp  extends com.betfair.www.publicapi.types.exchange.v5.APIResponse  implements java.io.Serializable {
    private com.betfair.www.publicapi.types.exchange.v5.GetSilksErrorEnum errorCode;

    private java.lang.String minorErrorCode;

    private com.betfair.www.publicapi.types.exchange.v5.MarketDisplayDetailV2[] marketDisplayDetails;

    public GetSilksV2Resp() {
    }
    ...
    public GetSilksV2Resp(
           ...
           com.betfair.www.publicapi.types.exchange.v5.MarketDisplayDetailV2[] marketDisplayDetails) {
        super(
            header);
    ...
    /**
     * Gets the errorCode value for this GetSilksV2Resp.
     * 
     * @return errorCode
     */
    ...
    /**
     * Sets the errorCode value for this GetSilksV2Resp.
     * 
     * @param errorCode
     */
    ...
    /**
     * Gets the minorErrorCode value for this GetSilksV2Resp.
     * 
    ...
    /**
     * Sets the minorErrorCode value for this GetSilksV2Resp.
     * 
    ...
    /**
     * Gets the marketDisplayDetails value for this GetSilksV2Resp.
     * 
     * @return marketDisplayDetails
     */
    public com.betfair.www.publicapi.types.exchange.v5.MarketDisplayDetailV2[] getMarketDisplayDetails() {
        return marketDisplayDetails;
    }


    /**
     * Sets the marketDisplayDetails value for this GetSilksV2Resp.
     * 
     * @param marketDisplayDetails
     */
    public void setMarketDisplayDetails(com.betfair.www.publicapi.types.exchange.v5.MarketDisplayDetailV2[] marketDisplayDetails) {
        this.marketDisplayDetails = marketDisplayDetails;
    }

    private java.lang.Object __equalsCalc = null;
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof GetSilksV2Resp)) return false;
        GetSilksV2Resp other = (GetSilksV2Resp) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(GetSilksV2Resp.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://www.betfair.com/publicapi/types/exchange/v5/", "GetSilksV2Resp"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.betfair.com/publicapi/types/exchange/v5/", "MarketDisplayDetailV2"));
        elemField.setNillable(true);
